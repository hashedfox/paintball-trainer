...
const ACTIONS: { section: SectionId; label: string; desc: string; accent: string; iconColor: string; icon: string }[] = [
  {
    ...
    accent: 'from-pb-green/15 to-pb-green/5 border-[#2DD4A8]/20 hover:border-[#2DD4A8]/50',
  ...
  },
  {
    ...
    label: 'Challenges',
    desc: 'Earn XP & coins',
    accent: 'from-pb-amber/15 to-pb-amber/5 border-[#D4A843]/20 hover:border-[#D4A843]/50',
  ...
  },
  {
    ...
    label: 'Guides',
    desc: 'Learn & improve',
    accent: 'from-pb-blue/15 to-pb-blue/5 border-[#4A7BF7]/20 hover:border-[#4A7BF7]/50',
    iconColor: 'text-[#4A7BF7]',
  ...
  },
  {
    ...
    label: 'Persona',
    desc: 'Customize gear',
    accent: 'from-pb-purple/15 to-pb-purple/5 border-[#7C5BF0]/20 hover:border-[#7C5BF0]/50',
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
      {ACTIONS.map((action) => (
        ...
        >
          ...
          <div className="font-display text-[12px] font-bold text-[#F1F5F9] uppercase tracking-wider">{action.label}</div>
          <div className="text-[9px] text-[#64748B]">{action.desc}</div>
        </button>
      ))}
    </div>
  )
